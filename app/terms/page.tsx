          ...
          <div className="flex justify-between items-center h-32">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/terms" className="text-gray-900 hover:text-[#c42a83] px-3 py-2 rounded-md text-sm font-medium">
                  Terms
                </Link>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-200 mb-6">
            By accessing or using LLS Verify's SMS verification service ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service. These Terms apply to all users of the Service, including businesses, developers, and end users.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Description of Service</h2>
          <p className="text-gray-200 mb-6">
            LLS Verify provides a carrier-compliant SMS verification platform that allows businesses to verify customer phone numbers through a secure, pass-through verification page. The Service includes:
          </p>
          ...
          <p className="text-gray-200 mb-4">You agree not to use the Service to:</p>
          <ul className="list-disc pl-6 text-gray-200 mb-6 space-y-2">
          ...
          <p className="text-gray-200 mb-6">
            The Service and all content, features, and functionality are owned by LLS Verify and are protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, or create derivative works based on the Service without our express written permission.
          </p>
          ...
          <p className="text-gray-200 mb-6">
            Your use of the Service is also governed by our <Link href="/privacy" className="text-[#c42a83] hover:text-[#a32269] font-medium">Privacy Policy</Link>. By using the Service, you consent to our collection and use of information as described in the Privacy Policy.
          </p>
          ...
          <p className="text-gray-200 mb-6">
            You agree to indemnify, defend, and hold harmless LLS Verify and its officers, directors, employees, and agents from any claims, liabilities, damages, losses, and expenses (including reasonable attorney fees) arising from:
          </p>
          <ul className="list-disc pl-6 text-gray-200 mb-6 space-y-2">
          ...
          <p className="text-gray-200 mb-6">
            These Terms, together with our Privacy Policy, constitute the entire agreement between you and LLS Verify regarding the Service and supersede all prior agreements.
          </p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            <p className="text-gray-200 mb-2"><strong>Email:</strong> <a href="mailto:legal@llsverify.com" className="text-[#c42a83] hover:text-[#a32269]">legal@llsverify.com</a></p>
            <p className="text-gray-200 mb-2"><strong>Support:</strong> <a href="mailto:support@llsverify.com" className="text-[#c42a83] hover:text-[#a32269]">support@llsverify.com</a></p>
            <p className="text-white"><strong>Website:</strong> <a href="/" className="text-[#c42a83] hover:text-[#a32269]">https://llsverify.com</a></p>
          </div>
